...
import { getDatabase, ref, set, get, onValue, update, push, remove, off, onDisconnect, serverTimestamp, query, limitToLast, runTransaction } from "firebase/database";
...
window.__fbDB={getDatabase:()=>db,ref,set,get,onValue,update,push,remove,off,onDisconnect,serverTimestamp,query,limitToLast,runTransaction};
