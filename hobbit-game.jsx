...
export default function BoardGame({user}){
  ...
  if(screen==="lobby") return (
    <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:20,padding:24}}>
      <div style={{textAlign:"center"}}>
        <div style={{fontSize:"3rem",marginBottom:8,animation:"emFl 3s ease-in-out infinite"}}>🎲</div>
        <div style={{fontFamily:"'Cinzel Decorative',serif",fontSize:"clamp(1.1rem,3.5vw,1.5rem)",color:"var(--gold)",textShadow:"0 0 24px rgba(201,168,76,.35)"}}>Középföld Honfoglalója</div>
        <div style={{fontFamily:"'Cinzel',serif",fontSize:".65rem",color:"var(--gm)",letterSpacing:".15em",textTransform:"uppercase",marginTop:4}}>— Online Társasjáték —</div>
        <div style={{fontFamily:"'EB Garamond',serif",fontSize:".85rem",color:"var(--td)",fontStyle:"italic",marginTop:8,lineHeight:1.6,maxWidth:320}}>
          2-4 játékos. Zsákos-dombtól Ereborig. Kvízek, csapdák, Gollam találós kérdések és Smaug tüze vár!
        </div>
      </div>
      <div style={{display:"flex",alignItems:"center",gap:8,padding:"6px 14px",background:"rgba(201,168,76,.05)",border:"1px solid rgba(201,168,76,.15)"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10,width:"100%",maxWidth:300}}>
        <button onClick={createGame} style={{padding:"13px",background:"rgba(201,168,76,.1)",border:"1px solid rgba(201,168,76,.4)",color:"var(--gold)",fontFamily:"'Cinzel',serif",fontSize:".78rem",letterSpacing:".12em",cursor:"pointer",textTransform:"uppercase"}}>+ Új Szoba</button>
